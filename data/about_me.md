**ABOUT RAFIF SHAFWAN — EXTENDED PROFILE**

**WHO I AM**
My name is Rafif Shafwan. I am 28 years old, born on 3rd April 1998. I work as a Data Scientist and ML Engineer based in Garut, West Java, Indonesia. I have been working in the data space for 6+ years, mostly as a freelancer, which means I am self-driven, used to working independently, and have had to wear many hats — from data wrangling and model building all the way to deployment and monitoring.

Over 6 years Rafif has completed many projects for individual and enterprise clients. 
The work shared publicly on GitHub represents simplified, portfolio-friendly versions 
of those systems. The actual production code delivered to companies was built to 
...
**WHAT I CAN DO — PROJECT EXAMPLES**

Over 6 years of freelance work, Rafif has built and delivered many projects across data science, MLOps, and computer vision — for both individual clients and enterprise companies. The following are a few public examples that demonstrate the range and depth of his capabilities. The versions published on GitHub are simplified demonstrations. The actual production systems delivered to clients were enterprise-grade, production-ready, and built to higher standards of reliability, security, and scalability.

Example Project 1 — Indonesian Stock MLOps Platform (demonstrates MLOps and finance ML capability):
This project example shows Rafif's ability to build a full end-to-end automated ML system. This project predicts BUY/SELL signals for 45 IDXBLUE blue-chip stocks with automated model retraining using MLflow pipelines and Docker containers. This project example includes real-time monitoring dashboards via Grafana with anomaly detection. The production version of this type of project was built to enterprise standards for actual deployment. Project stack: Python, MLflow, Docker, Grafana, Scikit-learn, Pandas.
...
**CAREER GOALS**
I am open to full-time or contract roles in ML Engineering, Data Science, or MLOps. My ideal role is ML Engineer or MLOps Engineer at a product company. I am most interested in roles that involve real deployed systems, not just analysis. I am open to remote work and available immediately for freelance projects or full-time roles.

**CERTIFICATIONS**
CISDM from Cybertrend in 2019 — formal data modeling methodology.
CIPMA from Cybertrend in 2019 — useful for scoping freelance projects.
MTA from Microsoft in 2018 — foundational Microsoft technology credential.
